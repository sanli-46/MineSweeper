...
public class MineSweeper {
    static String[][] harita(int a, int b) {
        ...
        // Mayin Koyma
        while (i < mine) {
            int randomrow = randomNumber.nextInt(hig - low) + low;
            int randomcol = randomNumber.nextInt(hig2 - low) + low;
    ...
    static String[][] kontrol(String[][] alan, String[][] bosAlan, int x, int y) {
        ...
        while (devam) {
            ...
            if (alan[a][b].equals(" * ")) {
                ...
                System.out.println("==Mayin Tarlası==");
